...
# Reference:
# https://data-transpower.opendata.arcgis.com/datasets/0c8db240553f47b5844bdc2eb1146b9b_0/explore
item_id = "0c8db240553f47b5844bdc2eb1146b9b"
...
col_names_str = "MXLOCATION,designvolt,status,description,type,Shape__Length"
...
for page in range(n_pages):
    try:
        ...
        for feature in features:
            try:
                result = {
                    "line_id": feature['properties']['MXLOCATION'],
                    "name": feature['properties']['description'],
                    "line_type": feature['properties']['type'],
                    "length_m": feature['properties']['Shape__Length'],
                    "kilovolt": feature['properties']['designvolt'],
