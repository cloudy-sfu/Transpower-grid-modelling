...
response = session.get(
    "https://www.emi.ea.govt.nz/Wholesale/Datasets/Metered_data/Grid_export",
...
sql_get_year_month = sql_get_year_month.replace(":table_name", "grid_export")
...
pbar = tqdm(desc="Grid export", total=len(rows))
for row in rows:
    ...
    try:
        ...
        a_href_1 = ("https://emidatasets.blob.core.windows.net/publicdata/Datasets/"
                    "Wholesale/Metered_data/Grid_export/") + fn
