...
from sqlite_ops import upsert, insert_skip_conflict
...
response = session.get(
    "https://www.emi.ea.govt.nz/Wholesale/Datasets/Metered_data/Grid_import",
...
sql_get_year_month = sql_get_year_month.replace(":table_name", "grid_import")
...
for row in tqdm(web_page.find("table").find_all('tr', recursive=False)):
    ...
    try:
        ...
        a_href_1 = ("https://emidatasets.blob.core.windows.net/publicdata/Datasets/"
                    "Wholesale/Metered_data/Grid_import/") + fn
